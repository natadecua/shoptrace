...
This is what makes the app valuable on day one. **Separate backend, integrated by API** — exactly the seam in ShopTrace PRD Section 34. **Full contract:** `docs/integration-api.md`.
